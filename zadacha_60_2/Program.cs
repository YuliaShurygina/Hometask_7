// Частотный словарь массива символов
...
char[] SortingArray(int[] array, string str)
{
...
string[] ChangingName(char[] symbols)
{
...
char[] arrangedSymbols = SortingArray(frequencyArray, symbols);
string[] space = ChangingName(arrangedSymbols);
