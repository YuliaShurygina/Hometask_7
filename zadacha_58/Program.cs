...
int [,] ChangeRowsToColomns(int[,] someMatrix)
{
...
if (m == n)
{
    int[,] changedMatrix = ChangeRowsToColomns(matrix);
    PrintArray(changedMatrix);
}
else
    Console.WriteLine("Заменить строки на столбцы невозможно: матрица неквадратная ");